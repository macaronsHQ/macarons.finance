<div class="flex justify-center items-center h-screen w-screen relative">
	<div class="flex gap-16 flex-col">
		<img src="macarons-logo.png" alt="Future of France" width="300" height="auto" class="" />
	</div>
	<div class="w-full flex justify-center absolute bottom-8">
		<strong
			><small class="flex gap-2"
				>Powered by <svg
					...
					height="24px"
					name="FraxtalIcon"
					><circle cx="141.73" cy="141.73" r="141" fill="#fff"></circle><circle
						cx="141.73"
						cy="141.73"
						r="129"
						fill="#000"
